...
#extract draws
print("extract draws")
draws <- posterior::as_draws_matrix(fit$draws(c('alpha_rew', 'alpha_pun','beta')))
mean_draws <- posterior::as_draws_matrix(fit$draws(c('mu_alpha_rew', 'mu_alpha_pun','mu_beta')))
