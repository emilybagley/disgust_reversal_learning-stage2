...
#extract draws
print("extract draws")
draws <- posterior::as_draws_matrix(fit$draws(c('e_alpha', 'p_alpha','e_beta',  'p_beta')))
mean_draws <- posterior::as_draws_matrix(fit$draws(c('mu_e_alpha','mu_p_alpha','mu_e_beta', 'mu_p_beta')))
