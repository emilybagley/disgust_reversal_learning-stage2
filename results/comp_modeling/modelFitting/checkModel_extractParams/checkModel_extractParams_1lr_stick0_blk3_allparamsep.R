...
#extract draws
print("extract draws")
draws <- posterior::as_draws_matrix(fit$draws(c('d_alpha','f_alpha', 'p_alpha','d_beta', 'f_beta', 'p_beta')))
mean_draws <- posterior::as_draws_matrix(fit$draws(c('mu_d_alpha','mu_f_alpha', 'mu_p_alpha','mu_d_beta', 'mu_f_beta', 'mu_p_beta')))
