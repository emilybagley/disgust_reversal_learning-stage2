...
#extract draws
print("extract draws")
draws <- posterior::as_draws_matrix(fit$draws(c('p_alpha_rew', 'p_alpha_pun','p_beta', 'e_alpha_rew', 'e_alpha_pun','e_beta')))
mean_draws <- posterior::as_draws_matrix(fit$draws(c('mu_p_alpha_rew', 'mu_p_alpha_pun','mu_p_beta', 'mu_e_alpha_rew', 'mu_e_alpha_pun','mu_e_beta')))
