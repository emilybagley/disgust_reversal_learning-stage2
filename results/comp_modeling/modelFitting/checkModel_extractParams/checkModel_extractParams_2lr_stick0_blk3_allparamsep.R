...
#extract draws
print("extract draws")
draws <- posterior::as_draws_matrix(fit$draws(c('p_alpha_rew', 'p_alpha_pun','p_beta', 'd_alpha_rew', 'd_alpha_pun','d_beta', 'f_alpha_rew', 'f_alpha_pun','f_beta')))
mean_draws <- posterior::as_draws_matrix(fit$draws(c('mu_p_alpha_rew', 'mu_p_alpha_pun','mu_p_beta', 'mu_d_alpha_rew', 'mu_d_alpha_pun','mu_d_beta', 'mu_f_alpha_rew', 'mu_f_alpha_pun','mu_f_beta')))
