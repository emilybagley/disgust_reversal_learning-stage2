...
echo "runRandomModel.R"
echo "$modelName"
srun Rscript runRandomModel.R $modelName $stanFile $dataFile $chains $parallel_chains $iter_warmup $iter_sampling $thin $save_warmup $output_dir
