...
Data folder:
Contains original data (raw jatos files) and unblinding document [not shared due to PID]
...
//modelFitting (within comp_modeling): contains all files necessary to fit data to all models in the model space 
