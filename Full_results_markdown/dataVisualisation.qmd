...
<p>This file contains the code for the graphs included in the paper </p>

<h3>1. Video ratings task plots</h3>
...
<h3>2. Hypothesis testing plots</h3>
...
<p><b>And finally, for the exploratory percentage correct outcome</b></p>
```{python}
#| code-fold: true
palette = ["#F72585", "#3A0CA3", "#4CC9F0"]
dark_palette = ["#9B0F47", "#5E2E9D", "#2487B8"]
...
<h3> 3. Examining the nature of outliers in the perseverative error outcome</h3>
